...
- **Mọi script trong `.codex/hooks/` bắt buộc khai trong `.codex/hooks.json`.** Không khai thì không bao giờ tự chạy — quy ước suông đội lốt cưỡng chế. `doc-budget.js` tự kiểm điều này.
