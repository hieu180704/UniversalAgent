# [TÊN DỰ ÁN] — Claude Code Guidelines

[Mô tả ngắn gọn về dự án]. Dự án hỗ trợ song song 3 engine AI độc lập: **Claude Code** (`.claude/`), **Antigravity IDE (Gemini)** (`.agents/`), **Codex CLI** (`.codex/`) — mỗi engine giữ bản rule/hook/skill/agent riêng, không phụ thuộc lõi trung lập hay symlinks.
